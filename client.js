/* Generated by scripts/build-client.mjs from client.body.js — do not edit. */
window.__ModuleLoader__.load({ id: "dsh-plan-graph", factory: (require) => {
  ...
  const styles = {
    insert: (css) => {
      ...
      tag.dataset.plugin = "dsh-plan-graph";
      tag.textContent = css;
